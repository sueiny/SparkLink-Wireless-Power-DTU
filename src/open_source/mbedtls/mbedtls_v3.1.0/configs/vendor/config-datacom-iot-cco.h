/**
 * \file config-datacom-iot-cco.h
 *
 * \brief 数据通信产品线IOT Gateway产品PLC CCO的mbedtls库的配置文件，基于3.1.0版本的suite-b配置文件。
 *
 *  产品在使用时，在编译前，将此文件强制覆盖默认的配置文件即可，使用方式如下：
 *  cp -f ./configs/vendor/config-datacom-iot-cco.h ./include/mbedtls/mbedtls_config.h
 */
