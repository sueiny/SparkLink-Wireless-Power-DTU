...
#define CONFIG_PKE_SUPPORT_BIG_NUMBER 1
...
#define CONFIG_UART_SUPPORT_RX_THREAD_DEBUG 1
#define CONFIG_UART_FIFO_DEPTH 64
#define CONFIG_UART_NOT_SUPPORT_RX_CONDITON_SIZE_OPTIMIZE 1
...
#define CONFIG_DRIVER_SUPPORT_LITEOS_207_0_0 1
